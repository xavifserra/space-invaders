...
Enemy.prototype._selectRole = function (role) {
  switch (role) {
    ...
    case 'veteran':
      ...
      this.character = new Sprite(setup.enemyL2Image, 1, 3, 69, 24, 3) // TODO: change num for var or parametre
      this.explosion = new Sprite(explosions.type3.image, explosions.type3.rows, explosions.type3.cols, explosions.type3.width, explosions.type3.height, explosions.type3.frames)
      break
    case 'official':
      this.type = role
    ...
    case 'boss':
      this.type = role
      this.color = setup.boss.enemyBossColor
      this.points = setup.boss.enemyBossPoints()
      this.width = setup.boss.enemyBossWidth;
      this.height = setup.boss.enemyBossHeiht;
      this.character = new Sprite(setup.boss.enemyBossImage, 1, 3, 144, 49, 3)// 120, 43, 3);
