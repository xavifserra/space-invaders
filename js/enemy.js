function Enemy(xPos, yPos, role, width, height, speed) {
  this.type = undefined
...
Enemy.prototype._selectRole = function (role) {
  switch (role) {
    case 'rookie':
      this.type = role
      this.width = this.width > 0 ? this.width : enemies.rookie.width
      this.height = this.height > 0 ? this.height : enemies.rookie.height
    ...
    case 'veteran':
      this.type = role
      this.width = this.width > 0 ? this.width : enemies.veteran.width
      this.height = this.height > 0 ? this.height : enemies.veteran.height
    ...
    case 'official':
      this.type = role
      this.width = this.width > 0 ? this.width : enemies.official.width
      this.height = this.height > 0 ? this.height : enemies.official.height
    ...
    case 'boss':
      this.type = role
      this.width = typeof this.width === 'undefined' ? this.width : enemies.boss.width
      this.height = typeof this.height === 'undefined' ? this.height : enemies.boss.height
